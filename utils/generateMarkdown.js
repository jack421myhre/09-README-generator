...
// Returns the correct license badge image based on what the user selected.
...
// If there is no license, return an empty string
// Returns the correct link to the license based on what the user selected.
...
// If there is no license, return an empty string
// Returns the correct license description based on what the user selected.
...
// The markdown template that passes in the user answers.
